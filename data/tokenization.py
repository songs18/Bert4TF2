...
def validate_case_matches_checkpoint(do_lower_case, init_checkpoint):
    ...
    if (model_name in lower_models and not do_lower_case) or (model_name in cased_models and do_lower_case):
        raise ValueError('validate case matches checkpoint fail')
...
class BasicTokenizer(object):
    ...
    def tokenize(self, text):
        ...
        output_tokens = whitespace_tokenize(" ".join(split_tokens))  # doing:: ?
